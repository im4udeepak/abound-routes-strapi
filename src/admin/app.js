...
const config = {
  ...
  translations: {
    en: {
      ...
      "Auth.form.button.login.strapi": "Log in via Abound Routes Admin",
      ...
      "Auth.form.register.subtitle": "Credentials are only used to authenticate in Abound Routes. All saved data will be stored in your database.",
      "Auth.form.rememberMe.label": "Remember me",
      "Auth.form.username.label": "Username",
      "Auth.form.username.placeholder": "e.g. Kai_Doe",
      "Auth.form.welcome.subtitle": "Log in to your Abound Routes admin account",
      ...
      "HomePage.welcome.congrats.content": "You are logged in as the first administrator. To discover the powerful features provided by Abound Routes,",
      ...
      "Settings.permissions.users.listview.header.subtitle": "All the users who have access to the Abound Routes admin panel",
      ...
      "admin.pages.MarketPlacePage.plugin.tooltip.madeByStrapi": "Made by Abound Routes",
      "admin.pages.MarketPlacePage.plugin.tooltip.verified": "Plugin verified by Abound Routes",
      ...
      "admin.pages.MarketPlacePage.subtitle": "Get more out of Abound Routes",
      "admin.pages.MarketPlacePage.tab-group.label": "Plugins and Providers for Abound Routes",
      ...
      "app.components.BlockLink.blog.content": "Read the latest news about Abound Routes and the ecosystem.",
      ...
      "app.components.BlockLink.tutorial.content": "Follow step-by-step instructions to use and customize Abound Routes.",
      ...
      "app.components.HomePage.welcomeBlock.content": "Congrats! You are logged as the first administrator. To discover the powerful features provided by Abound Routes, we recommend you to create your first Content type!",
      "app.components.HomePage.welcomeBlock.content.again": "We hope you are making progress on your project! Feel free to read the latest news about Abound Routes. We are giving our best to improve the product based on your feedback.",
      ...
      "app.components.LeftMenu.navbrand.workplace": "Abound Routes",
      ...
      "app.components.MarketplaceBanner": "Discover plugins built by the community, and many more awesome things to kickstart your project, on Abound Routes Awesome.",
      "app.components.MarketplaceBanner.image.alt": "a abound routes rocket logo",
      ...
      "app.components.UpgradePlanModal.text-power": "Unlock the full power of Abound Routes by upgrading your plan to the Enterprise Edition",
      "app.components.UpgradePlanModal.text-strapi": "of Abound Routes by upgrading your plan to the",
      ...
      "components.AutoReloadBlocker.description": "Run Abound Routes Admin with one of the following commands:",
      ...
      "global.plugins.sentry.description": "Send Abound Routes error events to Sentry.",
